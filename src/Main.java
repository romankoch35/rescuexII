public class Main {
    public static void main(String[] args) {
        ...
        int total2 = initBalance - added + bonus;

        System.out.println("Ваш баланс: " + total + "рублей. "); // как быстро вводить эту команду, как на разборном вебинаре?
        System.out.println("----------------------------"); // для красоты
        System.out.println("Доступно бонусов: " + bonus + " рублей.");
    }
}